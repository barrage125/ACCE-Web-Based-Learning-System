...
;
            ...
            new Course{CourseNo="3222",CourseName="Virtual Gym",Department = department[0],DepartmentID=department[0].ID},
            new Course{CourseNo="3333",CourseName="Trigonometry",Department = department[0],DepartmentID=department[0].ID},
            new Course{CourseNo="4444",CourseName="Intro to Computer Science",Department = department[0],DepartmentID=department[0].ID},
            new Course{CourseNo="5555",CourseName="Basic Math",Department = department[0],DepartmentID=department[0].ID},
            new Course{CourseNo="6666",CourseName="Grammar",Department = department[0],DepartmentID=department[0].ID},
            new Course{CourseNo="7777",CourseName="Vocabulary",Department = department[0],DepartmentID=department[0].ID},
            new Course{CourseNo="8888",CourseName="Nutrition",Department = department[0],DepartmentID=department[0].ID},
            new Course{CourseNo="9999",CourseName="Art",Department = department[0],DepartmentID=department[0].ID},
            new Course{CourseNo="1122",CourseName="Trash",Department = department[0],DepartmentID=department[0].ID},
            new Course{CourseNo="3234",CourseName="Trash II",Department = department[0],DepartmentID=department[0].ID},
            ...
            new CourseContent{Content="1050", Course=courses[7], CourseID= courses[7].ID},
            new CourseContent{Content="1050", Course=courses[8], CourseID= courses[8].ID},
            new CourseContent{Content="1050", Course=courses[9], CourseID= courses[9].ID},
            new CourseContent{Content="1050", Course=courses[10], CourseID= courses[10].ID},
            new CourseContent{Content="1050", Course=courses[11], CourseID= courses[11].ID},
            new CourseContent{Content="1050", Course=courses[12], CourseID= courses[12].ID},
            ...
            new Section{SectionNo=03, Course=courses[2], CourseID= courses[2].ID, Capacity =700},
            new Section{SectionNo=04, Course=courses[3], CourseID= courses[3].ID, Capacity =300},
            new Section{SectionNo=05, Course=courses[4], CourseID= courses[4].ID, Capacity =220},
            new Section{SectionNo=06, Course=courses[5], CourseID= courses[5].ID, Capacity =230},
            new Section{SectionNo=07, Course=courses[6], CourseID= courses[6].ID, Capacity =210},
            new Section{SectionNo=08, Course=courses[7], CourseID= courses[7].ID, Capacity =200},
            new Section{SectionNo=09, Course=courses[8], CourseID= courses[8].ID, Capacity =500},
            new Section{SectionNo=10, Course=courses[9], CourseID= courses[9].ID, Capacity =700},
            new Section{SectionNo=11, Course=courses[10], CourseID= courses[10].ID, Capacity =300},
            new Section{SectionNo=12, Course=courses[11], CourseID= courses[11].ID, Capacity =220},
            new Section{SectionNo=13, Course=courses[12], CourseID= courses[12].ID, Capacity =230},
